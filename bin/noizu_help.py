...
➣ 🆗 No changes needed, the output is satisfactory. ➥
    """
    return Msg(agent="core", type="core", role="user", content=m, brief=brief)
...
The previous message contains <llm-*></llm-*> annotation items generated by GPT-OPS and GPT-EXPORT. Please review, make the requested changes,
remove their annotation after addressing and prepare a new #{c} revision for our teams review.
    """
    ...
    if revise_flag:
        ...
        for line in diff_lines:
            if line.startswith("---") or line.startswith("+++"):
                ...
                revision_notes += "\033[92m" + line + "\033[0m"
            elif line.startswith("-"):
                revision_notes += "\033[91m" + line + "\033[0m"
            else:
                revision_notes += line
        revision_notes += "```\n\n"
